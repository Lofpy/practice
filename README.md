...
ロビーから選択できる独立モード **Survival（Java 26.3 専用）**を追加しました。
ワールド管理・編集・復元付き削除、Online / Ping / 座標のスコアボードについては
[Survival 運用ガイド](docs/SURVIVAL.md)を参照してください。Paper 26.3 の固定ビルドは ALPHA です。
